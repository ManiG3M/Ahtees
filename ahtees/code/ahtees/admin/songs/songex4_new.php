...
if ($movie_id) 
{
	$qry = "SELECT song_singer.*, customer_master.first_name, customer_master.last_name, customer_master.star_name FROM song_singer,customer_master WHERE song_singer.song_id = ".$song_id ." AND song_singer.customer_id = customer_master.customer_id ";
	...
	<tr>
		<td width="50%" valign="top">
			<table cellpadding="0" cellspacing="1" border="0" width="100%">
				<form name="searchcastformsinger" enctype="multipart/form-data" method="post" action="songex4_new.php">
			...
			<?php } ?>
				...
				<tr>
					<td>&nbsp;</td>
					<?php if (isset($_SESSION["mcastsingerid"])) { ?>
						<td><input type="submit" value="Modify Cast">&nbsp;&nbsp;<input type="button" value="New Singer" onclick="javascript:location.href='songex4_new.php?newsinger=1&movie_id=<?php echo $movie_id; ?>&song_id=<?php echo $song_id; ?>';"/></td>				
					<?php } else { ?>
		...
		<div style="overflow:auto; height:140px; width:360px"> 
			<table>
				...
				<tr bgcolor="<?php echo $bgcolor; ?>">
					...
					<td><a href="songex4_new.php?deletesinger=<?php echo $ccast["id"]; ?>&movie_id=<?php echo $movie_id; ?>&song_id=<?php echo $song_id; ?>">delete</a></td>
				</tr>
				<?php 
				if ($bgcolor == "WHITE")
				{
