...
if ($_POST)
{
	...
	add_record("system_lang_code_master", $data);
}

if (isset($_REQUEST["deletestatusm"]))
{
	delete_record_secondary("system_lang_code_master", $_REQUEST["deletestatusm"], "id");
}
...
<table width="93%">
	...
	<tr>
		...
		<td><a href="system_lang_code_master_edit.php?id=<?php echo $statusm["id"]; ?>">edit</a>&nbsp;&nbsp;<a href="system_lang_code_master.php?deletestatusm=<?php echo $statusm["id"]; ?>">delete</a></td>
	</tr>
