...
if ($_POST)
{
	...
	$where = "id = ".$_POST["id"];
	modify_record("education_degree_master", $data, $where);
	$modmsg = "<font color='red'>Formats Updated, Close Window and refresh Customer Status Master</font>";
	header("location: education_degree_master.php");
	}

$qry = "SELECT * FROM education_degree_master WHERE id=".$id;
...
<table align="left">
	<tr>
		...
		<td><input type="text" name="name" value="<?php echo $format["name"]; ?>"/></td>
