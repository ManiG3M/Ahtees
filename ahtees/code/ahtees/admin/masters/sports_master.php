...
if ($_POST)
{
	...
	add_record("sports_master", $data);
}

if (isset($_REQUEST["deletesport"]))
{
	delete_record_secondary("sports_master", $_REQUEST["deletesport"], "id");
}
...
<body bgcolor="#CCCCCC">
<form name="addsport" enctype="multipart/form-data" method="post">
<table align="center">
	<tr>
...
<table width="93%">
	...
	<tr>
		...
		<td><a href="sports_master_edit.php?id=<?php echo $sport["id"]; ?>">edit</a>&nbsp;&nbsp;<a href="sports_master.php?deletesport=<?php echo $sport["id"]; ?>">delete</a></td>
	</tr>
