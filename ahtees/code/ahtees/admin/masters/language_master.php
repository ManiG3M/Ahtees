...
if ($_POST)
{
	...
	add_record("language_master", $data);
}

if (isset($_REQUEST["deletelang"]))
{
	delete_record_secondary("language_master", $_REQUEST["deletelang"], "id");
}
...
<body bgcolor="#CCCCCC">
<form name="addlang" enctype="multipart/form-data" method="post">
<table align="center">
	<tr>
...
<table width="93%">
	...
	<tr>
		...
		<td><a href="language_master_edit.php?id=<?php echo $language["id"]; ?>">edit</a>&nbsp;&nbsp;<a href="language_master.php?deletelang=<?php echo $language["id"]; ?>">delete</a></td>
	</tr>
