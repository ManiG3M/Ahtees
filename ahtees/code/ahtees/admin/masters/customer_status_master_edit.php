...
if ($_POST)
{
	...
	$where = "id = ".$_POST["id"];
	modify_record("customer_status_master", $data, $where);
	$modmsg = "<font color='red'>Status Updated, Close Window and refresh Customer Status Master</font>";
	header("location: customer_status_master.php");
	}

$qry = "SELECT * FROM customer_status_master WHERE id=".$id;
...
<table align="left">
	<tr>
		...
		<td><input type="text" name="description" value="<?php echo $status["description"]; ?>"/></td>
