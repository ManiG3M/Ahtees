...
if ($_POST)
{
	...
	add_record("text_type_master", $data);
}

if (isset($_REQUEST["deletect"]))
{
	delete_record_secondary("text_type_master", $_REQUEST["deletect"], "id");
}

$qry = "SELECT * FROM text_type_master";
...
<table width="93%">
	...
	<tr>
		...
		<td><a href="text_type_master_edit.php?id=<?php echo $content["id"]; ?>">edit</a>&nbsp;&nbsp;<a href="text_type_master.php?deletect=<?php echo $content["id"]; ?>">delete</a></td>
	</tr>
