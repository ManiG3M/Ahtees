...
if ($_POST)
{
	...
	add_record("aspect_ratio_master", $data);
}

if (isset($_REQUEST["deleteformat"]))
{
	delete_record_secondary("aspect_ratio_master", $_REQUEST["deleteformat"], "id");
}

$qry = "SELECT * FROM aspect_ratio_master order by description";
...
<table width="93%">
	...
	<tr>
		...
		<td><a href="aspect_ratio_master_edit.php?id=<?php echo $format["id"]; ?>">edit</a>&nbsp;&nbsp;<a href="aspect_ratio_master.php?deleteformat=<?php echo $format["id"]; ?>">delete</a></td>
	</tr>
