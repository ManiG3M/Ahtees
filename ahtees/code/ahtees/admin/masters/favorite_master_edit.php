...
if ($_POST)
{
	...
	$where = "id = ".$_POST["id"];
	modify_record("favorite_master", $data, $where);
	$modmsg = "<font color='red'>Formats Updated, Close Window and refresh Customer Status Master</font>";
	header("location: favorite_master.php");
	}

$qry = "SELECT * FROM favorite_master WHERE id=".$id;
...
<form name="editfavorite" enctype="multipart/form-data" method="post">
<input type="hidden" name="id" value="<?php echo $id; ?>" />
<table align="left">
	<tr>
		<td><strong>Edit:</strong></td>
		<td><input type="text" name="description" value="<?php echo $favorite["description"]; ?>"/></td>
