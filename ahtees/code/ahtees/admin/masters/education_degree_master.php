...
if ($_POST)
{
	...
	add_record("education_degree_master", $data);
}

if (isset($_REQUEST["deleteformat"]))
{
	delete_record_secondary("education_degree_master", $_REQUEST["deleteformat"], "id");
}

$qry = "SELECT * FROM education_degree_master";
...
<table width="93%">
	...
	<tr>
		...
		<td><a href="education_degree_master_edit.php?id=<?php echo $format["id"]; ?>">edit</a>&nbsp;&nbsp;<a href="education_degree_master.php?deleteformat=<?php echo $format["id"]; ?>">delete</a></td>
	</tr>
