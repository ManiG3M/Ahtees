...
if ($_POST)
{
	...
	$where = "id = ".$_POST["id"];
	modify_record("content_type_master", $data, $where);
	$modmsg = "<font color='red'>Content Type Updated, Close Window and refresh Customer Status Master</font>";
	header("location: content_type_master.php");
	}

$qry = "SELECT * FROM content_type_master WHERE id=".$id;
...
<table align="left">
	<tr>
		...
		<td><input type="text" name="description" value="<?php echo $content["description"]; ?>"/></td>
