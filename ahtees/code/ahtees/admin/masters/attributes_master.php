...
if ($_POST)
{
	...
	add_record("attributes_master", $data);
}

if (isset($_REQUEST["deleteattribute"]))
{
	delete_record_secondary("attributes_master", $_REQUEST["deleteattribute"], "id");
}
...
<body bgcolor="#CCCCCC">
<form name="addattribute" enctype="multipart/form-data" method="post">
<table align="center">
	<tr>
...
<table width="93%">
	...
	<tr>
		...
		<td><a href="attributes_master_edit.php?id=<?php echo $attribute["id"]; ?>">edit</a>&nbsp;&nbsp;<a href="attributes_master.php?deleteattribute=<?php echo $attribute["id"]; ?>">delete</a></td>
	</tr>
