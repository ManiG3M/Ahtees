...
if ($_POST)
{
	...
	add_record("relation_master", $data);
}

if (isset($_REQUEST["deleteformat"]))
{
	delete_record_secondary("relation_master", $_REQUEST["deleteformat"], "id");
}

$qry = "SELECT * FROM relation_master";
...
<table width="93%">
	...
	<tr>
		...
		<td><a href="relation_master_edit.php?id=<?php echo $format["id"]; ?>">edit</a>&nbsp;&nbsp;<a href="relation_master.php?deleteformat=<?php echo $format["id"]; ?>">delete</a></td>
	</tr>
