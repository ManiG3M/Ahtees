...
if ($_POST)
{
	...
	$where = "id = ".$_POST["id"];
	modify_record("location_type_master", $data, $where);
	$modmsg = "<font color='red'>Locations Updated, Close Window and refresh Customer Status Master</font>";
	header("location: location_type_master.php");
	}

$qry = "SELECT * FROM location_type_master WHERE id=".$id;
...
<table align="left">
	...
	<tr>
		...
		<td><input type="text" name="description" value="<?php echo $loc["description"]; ?>"/>&nbsp;&nbsp;<input type="submit" value="Update" /></td>
	</tr>
</table>
</form>
