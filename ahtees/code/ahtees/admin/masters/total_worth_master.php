...
if ($_POST)
{
	...
	add_record("total_worth_master", $data);
}

if (isset($_REQUEST["deleteformat"]))
{
	delete_record_secondary("total_worth_master", $_REQUEST["deleteformat"], "id");
}

$qry = "SELECT * FROM total_worth_master";
...
<table width="93%">
	...
	<tr>
		...
		<td><a href="total_worth_master_edit.php?id=<?php echo $format["id"]; ?>">edit</a>&nbsp;&nbsp;<a href="total_worth_master.php?deleteformat=<?php echo $format["id"]; ?>">delete</a></td>
	</tr>
