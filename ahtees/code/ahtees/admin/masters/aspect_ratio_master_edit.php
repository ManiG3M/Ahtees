...
if ($_POST)
{
	...
	$where = "id = ".$_POST["id"];
	modify_record("aspect_ratio_master", $data, $where);
	header("location: aspect_ratio_master.php");
	}

$qry = "SELECT * FROM aspect_ratio_master WHERE id=".$id;
...
<table align="left">
	<tr>
		...
		<td><input type="text" name="description" value="<?php echo $format["description"]; ?>"/></td>
