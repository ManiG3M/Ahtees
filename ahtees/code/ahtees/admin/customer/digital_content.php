<?php 
if ($_POST["adddigitalcontentcus"])
{
	$target_path = "customer/content/".$_SESSION["custid"]."_".$_POST["content_type_id"]."_".$_FILES['content_path']['name'];
	if(move_uploaded_file($_FILES['content_path']['tmp_name'], $target_path)) 
	{
		...
		$data["content_path"] = "customer/content/".$_SESSION["custid"]."_".$_POST["content_type_id"]."_".$_FILES['content_path']['name'];
...
if ($_SESSION["custid"]) 
{
	...
	$qry = "SELECT customer_digital_content.*, content_type_master.description FROM customer_digital_content INNER JOIN content_type_master ON (customer_digital_content.content_type_id = content_type_master.id) WHERE customer_digital_content.customer_id = ".$_SESSION["custid"];
...
<table width ="100%" cellpadding="0" cellspacing="0" border="1">
	<tr>
		<td width="50%" valign="top">
			<form name="addaward" enctype="multipart/form-data" method="post" action="admin_add_customer.php">
		...
		<div style="overflow:auto; height:540px; width:560px"> 
			<table>
				...
				<tr bgcolor="<?php echo $bgcolor; ?>">
					...
					<td><a href="admin_add_customer.php?deletedcontent=<?php echo $cdigitalcontent["id"]; ?>&filename=<?php echo $cdigitalcontent["content_path"]; ?>">delete</a></td>
				</tr>
				<?php 
				if ($bgcolor == "WHITE")
				{
